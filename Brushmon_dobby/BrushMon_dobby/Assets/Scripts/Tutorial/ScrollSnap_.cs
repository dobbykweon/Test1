...
public class ScrollSnap_ : UIBehaviour, IDragHandler, IEndDragHandler {
	...
	public Action<int> onLerpCompleteCustom;
	...
	protected override void Awake() {
		...
		this.cellSpacing = content.GetComponent<GridLayoutGroup>().spacing.x;
		content.anchoredPosition = new Vector2(-cellSize.x * cellIndex +cellSpacing, content.anchoredPosition.y);
		...
		onLerpComplete.AddListener(onChanged);
		
	}

	public void onChanged(){
		if(onLerpCompleteCustom != null)
			onLerpCompleteCustom(CurrentIndex);
	}
