...
namespace Mopsicus.Plugins {
    ...
    public class DobbyMobileInputField : MobileInputReceiver {
        ...
        public bool dropDownFlag;

        public void SetDropDownFlag(bool dropDownFlag1)
        {
            dropDownFlag = dropDownFlag1;
            Debug.Log(dropDownFlag);
        }
        ...
        private void PrepareNativeEdit () {
            ...
            _config.PlaceholderFont = placeHolder.font.ToString();//도연생성
            _config.TextFont = _inputObjectText.font.ToString(); //도연생성
        ...
        private void CreateNativeEdit () {
            ...
            data["placeholder_font"] = _config.PlaceholderFont;///도연생성
            data["text_font"] = _config.TextFont;///도연생성
